...
#
# Modified by Piccia (C) <francesco.piccia@live.it>
#
...
class Arrow:
    ...
    def __init__(self, tail: Square, head: Square, *, color: str = "#FFF") -> None:
        self.tail = tail
        self.head = head
        self.color = color
    ...
    def pgn(self) -> str:
        ...
        if self.tail == self.head:
            return f"{self.color}{chess.SQUARE_NAMES[self.tail]}"
        else:
            return f"{self.color}{chess.SQUARE_NAMES[self.tail]}{chess.SQUARE_NAMES[self.head]}"
